...
public:
  ...
  bool radii_estimated_ = false;  // 是否已经估计过长短轴
...
private:
  ...
  void initEKF(const Armor & a, double r1, double r2);
  void tryEstimateRadiiOnceInUpdate(const Armors::SharedPtr & armors_msg);//try init r1/r2
  ...
  void EstimateRadiiTrisectionFromMsg(
